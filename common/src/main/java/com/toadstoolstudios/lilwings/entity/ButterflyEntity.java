...
public class ButterflyEntity extends AnimalEntity implements Flutterer, IAnimatable {
    ...
    private static final EntityDataAccessor<Integer> DATA_COLOR_TYPE = TrackedData.defineId(ButterflyEntity.class, EntityDataSerializers.INT);
    ...
    protected void initDataTracker() {
        ...
        this.getDataTracker().set(DATA_CATCH_AMOUNT, 0);
        this.getDataTracker().set(DATA_COLOR_TYPE, GraylingType.NORMAL.ordinal());
    }
