...
import com.toadstoolstudios.lilwings.block.ButterCauldron;
import com.toadstoolstudios.lilwings.block.ButterflyJarBlock;
import com.toadstoolstudios.lilwings.block.ButterflyJarBlockEntity;
import com.toadstoolstudios.lilwings.block.MilkCauldron;
...
public class LilWingsBlocks {
    ...
    public static final Supplier<Item> BUTTERNITE_BLOCK_ITEM = CommonServices.REGISTRY.registerItem("butternite_block", () -> new BlockItem(BUTTERNITE_BLOCK.get(), new Item.Settings().group(LilWingsItems.TAB)));
    ...
    public static final Supplier<Item> BUTTER_BLOCK_ITEM = CommonServices.REGISTRY.registerItem("butter_block", () -> new BlockItem(BUTTER_BLOCK.get(), new Item.Settings().group(LilWingsItems.TAB)));
    ...
    public static final Supplier<Item> CRIMSON_CAKE_ITEM = CommonServices.REGISTRY.registerItem("crimson_cake", () -> new BlockItem(CRIMSON_CAKE.get(), new Item.Settings().group(LilWingsItems.TAB)));
    ...
    public static final Supplier<Item> GOLDEN_CAKE_ITEM = CommonServices.REGISTRY.registerItem("golden_cake", () -> new BlockItem(GOLDEN_CAKE.get(), new Item.Settings().group(LilWingsItems.TAB)));
