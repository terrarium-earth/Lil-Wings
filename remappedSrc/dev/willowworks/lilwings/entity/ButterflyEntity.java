...
public class ButterflyEntity extends AnimalEntity implements Flutterer, IAnimatable {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        boolean canCatch = butterfly.netItem() == null ? handStack.isOf(LilWingsItems.BUTTERFLY_NET.get()) || handStack.isOf(LilWingsItems.ENDERFLY_NET.get()) : handStack.isIn(butterfly.netItem().get());
    ...
    public boolean isBreedingItem(ItemStack pStack) {
        return butterfly.breedingItem() != null && pStack.isIn(butterfly.breedingItem());
    }
