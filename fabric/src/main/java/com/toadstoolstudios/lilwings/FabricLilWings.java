...
public class FabricLilWings implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.tag(ConventionalBiomeTags.TAIGA), SpawnGroup.AMBIENT, LilWingsEntities.APONI_BUTTERFLY.entityType().get(), 25, 2, 2);
        BiomeModifications.addSpawn(BiomeSelectors.tag(ConventionalBiomeTags.JUNGLE), SpawnGroup.AMBIENT, LilWingsEntities.PAINTED_PANTHER_BUTTERFLY.entityType().get(), 25, 2, 2);
        BiomeModifications.addSpawn(BiomeSelectors.tag(ConventionalBiomeTags.SWAMP), SpawnGroup.AMBIENT, LilWingsEntities.SWAMP_HOPPER_BUTTERFLY.entityType().get(), 25, 2, 2);
        BiomeModifications.addSpawn(BiomeSelectors.tag(ConventionalBiomeTags.MUSHROOM), SpawnGroup.AMBIENT, LilWingsEntities.SHROOM_SKIPPER_BUTTERFLY.entityType().get(), 25, 2, 2);
        BiomeModifications.addSpawn(BiomeSelectors.tag(ConventionalBiomeTags.FOREST), SpawnGroup.AMBIENT, LilWingsEntities.RED_APPLEFLY_BUTTERFLY.entityType().get(), 25, 2, 2);
